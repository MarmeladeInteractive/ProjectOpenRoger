...
public class Npcs extends GameEntity {
    ...
    public Npcs(String gameName, int[] position) {
        super(position, "npc");
        this.gameName = gameName;
    }
    ...
    public void interact(MainGameWindow mainGameWindow) {
        ...
        if (!mainGameWindow.selectionWheel.isOpen && !mainGameWindow.interactiveInventory.isInventoryOpen)
            mainGameWindow.selectionWheel.openSelectionWheel(x, y, "npc", test);
        try {
            if (mainGameWindow.player.inputsManager.interactKeyPressed || (mainGameWindow.selectionWheel.isIconSelected
                    && mainGameWindow.selectionWheel.interactType == "npc")) {

                int compatibility = ideology.ideologicalCompatibility(character.ideologicalCode,
                        mainGameWindow.player.ideologicalCode);
                    ...
                    case "interactHello":
                        if (!currentResponce.equals("interactHello")) {
                            ...
                            if ((compatibility + interactScore * 5) > 40) {
                                response = "greet";
                                mainGameWindow.openChatPanel("Roger",
                                        save.getChildFromMapElements(allElementsRoger,
                                                "res" + String.valueOf(randomNumber)),
                                        name, save.getChildFromMapElements(allElementsNPCs,
                                                "res" + String.valueOf(randomNumber)));
                            } else {
                        ...
                        if (!currentResponce.equals("interactGiveBread")) {
                            ...
                            if (mainGameWindow.interactiveInventory.clickedItemName != "") {
                                if (mainGameWindow.player.inventory
                                        .incrementValue(mainGameWindow.interactiveInventory.clickedItemName, -1)) {
                                    ...
                                    if ((compatibility + interactScore * 5) > 30) {
                                        ...
                                        mainGameWindow.openChatPanel("Roger",
                                                ...
                                                name, save.getChildFromMapElements(allElementsNPCs,
                                                        "res" + String.valueOf(randomNumber)));
                                        mainGameWindow.player.inventory
                                                .incrementValue(mainGameWindow.interactiveInventory.clickedItemName, 1);
                                    }
