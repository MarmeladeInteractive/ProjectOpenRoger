...
public class Tools extends GameEntity {
    ...
    public Tools(String gameName, int id, int level, int[] position) {
        super(position, "tool");
        this.gameName = gameName;
    ...
    public void interact(MainGameWindow mainGameWindow) {
        ...
        try {
            if (mainGameWindow.interactiveListPanel.isSelectedValue
                    && mainGameWindow.interactiveListPanel.selectedValue.get(1) == "tool") {
            ...
            if (level == 0) {
                switch (id) {
                    case 0:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeElementChildValue(mainGameWindow.player.gameName, "partyHouse", "partyHouse",
                                    "partyHouse", "printerLevel", String.valueOf(1));
                    ...
                    case 1:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeElementChildValue(mainGameWindow.player.gameName, "partyHouse", "partyHouse",
                                    "partyHouse", "ovenLevel", String.valueOf(1));
                            mainGameWindow.player.inputsManager.interactKeyPressed = false;
                            refresh = true;
                        }
                        break;
                    case 2:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeElementChildValue(mainGameWindow.player.gameName, "partyHouse", "partyHouse",
                                    "partyHouse", "transportationLevel", String.valueOf(1));
                            mainGameWindow.player.inputsManager.interactKeyPressed = false;
                            refresh = true;
                        }
                        break;
                    ...
                    case 3:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeChunkBuildingType(mainGameWindow.player.gameName, mainGameWindow.player.chunk,
                                    0);
                ...
                switch (id) {
                    case 0:
                        ...
                        break;
                    case 1:
                        if ((mainGameWindow.player.inventory.maxChocolatines != mainGameWindow.player.inventory.itemsCount
                                .get("chocolatines"))
                                && (mainGameWindow.player.inventory.maxCroissants != mainGameWindow.player.inventory.itemsCount
                                        .get("croissants")))
                            if (mainGameWindow.player.isEnoughMoney(usePrice, true)) {
                                if ((mainGameWindow.player.inventory.maxChocolatines
                                        - mainGameWindow.player.inventory.itemsCount.get("chocolatines")) >= (level
                                                * 2)) {
                                    int val = mainGameWindow.player.inventory.itemsCount.get("chocolatines")
                                            + level * 2;
                                    mainGameWindow.player.inventory.itemsCount.replace("chocolatines", val);
                                } else {
                                    mainGameWindow.player.inventory.itemsCount.replace("chocolatines",
                                            mainGameWindow.player.inventory.maxChocolatines);
                                }
                                if ((mainGameWindow.player.inventory.maxCroissants
                                        - mainGameWindow.player.inventory.itemsCount.get("croissants")) >= (level
                                                * 2)) {
                                    ...
                                    mainGameWindow.player.inventory.itemsCount.replace("croissants",
                                            mainGameWindow.player.inventory.maxCroissants);
                                }
                ...
                switch (id) {
                    case 0:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeElementChildValue(mainGameWindow.player.gameName, "partyHouse", "partyHouse",
                                    "partyHouse", "printerLevel", String.valueOf(level));
                    ...
                    case 1:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeElementChildValue(mainGameWindow.player.gameName, "partyHouse", "partyHouse",
                                    "partyHouse", "ovenLevel", String.valueOf(level));
                            mainGameWindow.player.inputsManager.upgradeKeyPressed = false;
                            refresh = true;
                        }
                        break;
                    case 2:
                        if (mainGameWindow.player.isEnoughMoney(price, true)) {
                            ...
                            save.changeElementChildValue(mainGameWindow.player.gameName, "partyHouse", "partyHouse",
                                    "partyHouse", "transportationLevel", String.valueOf(level));
                            mainGameWindow.player.inputsManager.upgradeKeyPressed = false;
                            refresh = true;
                        }
                        break;
