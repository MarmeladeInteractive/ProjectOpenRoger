...
public class CustomizePartyScreen extends JPanel {
    ...
    public CustomizePartyScreen(String gameName, String seed, boolean cheatCodesEnabled) {
    ...
    public void ChangeComponents(int idParty){
        ...
        startButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                frame.dispose();
                Game game = new Game();
                game.startGame(gameName,seed,cheatCodesEnabled);
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CustomizePartyScreen("aboieaboiechieng","eeee",true);
            }
        });
    }
}
